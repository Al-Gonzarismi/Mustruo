...
-- -----------------------------------------------------
INSERT INTO `estado_cartas` (`id`, `descripcion`) VALUES ('0', 'baraja'), ('1', 'mano'), ('2', 'segundo'), ('3', 'postre_mano'), ('4', 'postre'), ('5', 'descarte');